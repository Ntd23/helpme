    ...
    transitionBuilder: (_, animation, secondaryAnimation, child) {
      return dialogAnimatedWrapperWidget(
        ...
        child: AlertDialog(
          ...
          elevation: 4,
          title: buildTitleWidget(context, dialogType, primaryColor, customCenterWidget, height ?? customDialogHeight, width ?? customDialogWidth, centerImage, shape),
          content: Container(
                ...
                Row(
                  children: [
                    Expanded(
                      child: TextButton(
                        onPressed: () {
                          if (cancelable) Navigator.pop(context, false);
                    ...
                    Expanded(
                      child: TextButton(
                        ...
                        style: TextButton.styleFrom(
                          ...
                          backgroundColor: getDialogPrimaryColor(context, dialogType, primaryColor),
                          shape: RoundedRectangleBorder(
                            borderRadius: BorderRadius.circular(defaultRadius),
                            side: BorderSide(color: viewLineColor),
                          ),
