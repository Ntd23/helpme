...
class PaymentScreenState extends State<PaymentScreen> {
  ...
  Future<void> paymentListApiCall() async {
    ...
    await getPaymentList().then((value) {
      ...
      paymentList.removeWhere((e) => e.type == PAYMENT_TYPE_PAYSTACK);
  ...
  /// Paypal Payment (Braintree removed)
  void payPalPayment() async {
    // Ở version này mình bỏ flutter_braintree, nên PayPal qua Braintree tạm thời không hỗ trợ.
    // Nếu cần, sau này có thể thay bằng WebView / REST API riêng.
    toast(language.paymentFailed);
    log('PayPal via Braintree is not supported in this build (flutter_braintree removed).');
  }
          ...
          child: AppButtonWidget(
            ...
            onTap: () {
              ...
              // }
                ...
                // Bây giờ chỉ báo lỗi, không dùng Braintree nữa
                payPalPayment();
